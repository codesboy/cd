...
class User extends Validate
{
    protected $rule = [
        'name'  =>  'require|max:25',
        'birthday'  =>  'date',
        'telephone' =>  ['require','regex'=>'/^1(3[0-9]|4[57]|5[0-35-9]|7[01678]|8[0-9])\d{8}$/'],
    ...
    // 验证场景
    protected $scene = [
        'users_info'  =>  ['name','birthday','telephone','province_id','city_id','county_id','dev_id'],
        'users_info_consumption'  =>  ['qtzx_id','disease_id','jz_time','money'],
        'users_consumption'  =>  ['jz_time','money']
    ];
}
